...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-12-12 11:00:45
-- 服务器版本： 5.6.17-log
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `cms_article_face` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文章封面图片列表' AUTO_INCREMENT=44 ;
...
('site_logo', 'type=img&style=width:240px', '/Public/images/face/20161212/584e605e83399.jpg', '站点logo', '网站的logo', 2, 7, 1),
