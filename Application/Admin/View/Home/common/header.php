...
<div id="right_tools_wrapper">
	<span id="right_tools_clearcache" title="清除缓存" onclick="javascript:openapp('/index.php?g=admin&m=setting&a=clearcache','right_tool_clearcache','清除缓存');">
			...
			<ul class="nav simplewind-nav pull-right">
				...
				<li class="light-blue">
					<a data-toggle="dropdown" href="{:U('Home/main')}#" class="dropdown-toggle">
						<img class="nav-user-photo" width="30" height="30" src="__PUBLIC__/admin/images/logo-18.png" alt="admin">
