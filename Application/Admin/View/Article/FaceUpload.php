...
<style>
    ...
    /*上传选择按钮*/
    #btupload,.addnew{
        background: url("__PUBLIC__/admin/js/swfupload/images/swfBnt.png") no-repeat; float:left; margin-right:10px;width:75px; height:28px; line-height:28px;font-weight:700; color:#fff;
    }
    #btupload{
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        Wind.use("swfupload",GV.DIMAUB+"__PUBLIC__/admin/js/swfupload/handlers.js",function(){
            swfu = new SWFUpload({
                flash_url:"__PUBLIC__/admin/js/swfupload/swfupload.swf",
