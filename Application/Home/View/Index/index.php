<div id="archives">
    <div id="topic-list">
        ...
        <div class="post-topic-area"> 友情链接</div>
        <div class="post-topic-form-result"></div>
        <div class="topics-wrapper flinkbg">
            <div class="popup-group">
                <div class="topic-section-wrapper no-1 interview-section">
                    <div class="topic-section clearfix">
                        <div class="topic-detail">

                            <div class="topic-friend">
                                <div id="post-1" class="friend">
                                    <ul>
                                        <?php $articleModel = new \Blog\Model\ArticleModel();$home_links = clone $articleModel->getLinks(); foreach($home_links->data as $key=>$value){ ?>
                                        <li><a href="{$value['summary']}" rel="bookmark" target="_blank">{$value['title']}</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
